...
public class ProductDao {
	...
	public List<Product> selectProduct() {
		...
		// 메소드
		try {
			products = session.selectList("product.mapper.ProductMapper.selecrtAllProducts");
	...
	public List<Product> selectMostAmount() {
		...
		try {
			mostQuantity = session.selectList("product.mapper.ProductMapper.selectMostQuantity", product);
		} finally {
			if (session != null) {
				session.close();
			}
